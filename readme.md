...
## Submission Notes/Start Up Procedure

Before building:
* Start a postgres db
* Update enviroment variables for application-local.yaml
* For testing convince I included an endpoint that creates a dummy container. This container uses an alpine image. If you wish to use this endpoint make sure a alpine image is present in docker.
